#!/usr/bin/env python3
"""
Quick verification benchmark - 12 games at depth 3.
"""
import os
import sys
import chess
...
def main():
    print("Verification Benchmark: 12 games at depth 3 vs SF 1320")
    print("=" * 50)
    ...
    score = (wins + 0.5 * draws) / 12 * 100
    
    print("=" * 50)
    print(f"Results: {wins}W-{draws}D-{losses}L = {score:.0f}%")
    
    if score >= 80:
        print("SUCCESS: Engine performing well!")
    elif score >= 60:
